"""
Django settings for desercion_escolar project.
...
SECRET_KEY = 'django-insecure-b3yh65a^7x1jmg-%t3idz#*f6n64+r56bp^tk27)5a7to*c6p&'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'prediccion-almacen1-production.up.railway.app',
...
ROOT_URLCONF = 'desercion_escolar.urls'
...
WSGI_APPLICATION = 'desercion_escolar.wsgi.application'
...
# Auth redirects (the project login is at "/")
LOGIN_URL = '/'
